...
const ICONS: Record<string, string> = {
  ...
  'scroll': '<path d="M19 17V5a2 2 0 0 0-2-2H4"/><path d="M8 21h12a2 2 0 0 0 2-2v-1a1 1 0 0 0-1-1H11a1 1 0 0 0-1 1v1a2 2 0 1 1-4 0V5a2 2 0 1 0-4 0v2"/>',
...
@Component({
  selector: 'app-icon',
  standalone: true,
  template: `<span class="icon-wrap" [innerHTML]="svgContent()" [style.width.px]="size()" [style.height.px]="size()"></span>`,
  styles: [`
    .icon-wrap {
      display: inline-flex;
      align-items: center;
...
export class IconComponent {
  ...
  svgContent = computed(() => {
    ...
    const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${this.size()}" height="${this.size()}" viewBox="0 0 24 24" fill="none" stroke="${this.color()}" stroke-width="${this.strokeWidth()}" stroke-linecap="round" stroke-linejoin="round">${path}</svg>`;
